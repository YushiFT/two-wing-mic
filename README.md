...
`PMCosm` (Version 0.1.5): <https://github.com/YushiFT/PMCosm>
...
Details for: TwoWing_hz_asv_2018.txt.zip
-----------------------------------------------

* Description: This file represents the dataset itself.
...
* Dimensions: 51441 rows; 60 columns
...
* Other encoding details:
 ...
 Details for: TwoWing_ao_asv.txt.zip
-----------------------------------------------
...
* Dimensions: 111981 rows; 66 columns
